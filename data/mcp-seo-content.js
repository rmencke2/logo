    ...
    crossLinkGroups: [
      {
        ...
        links: [
          ...
          { href: '/mcp/categories', label: 'Browse by category', desc: 'Dev tools, databases, search & web, and more' },
          { href: '/mcp/compare', label: 'Comparisons', desc: 'Firecrawl vs Exa, Postgres vs Neon, and more' },
          { href: '/mcp/best/claude', label: 'Best for Claude', desc: 'Desktop, claude.ai, and Claude Code stacks' },
    ...
    crossLinkGroups: [
      {
        ...
        links: [
          ...
          { href: '/mcp/categories', label: 'Categories', desc: 'Browse dev tools, databases, search & web' },
          { href: '/mcp/compare', label: 'Comparisons', desc: 'Firecrawl vs Exa, Postgres vs Neon, and more' },
          { href: '/mcp/best/claude', label: 'Best for Claude', desc: 'Desktop, claude.ai, and Claude Code stacks' },
